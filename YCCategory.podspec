...
Pod::Spec.new do |s|
  ...
  s.author             = { "王耀昌" => "email@address.com" }
  # Or just: s.author    = "王耀昌"
  # s.authors            = { "王耀昌" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/王耀昌"
  ...
  s.exclude_files = "YCCategory/Exclude"
